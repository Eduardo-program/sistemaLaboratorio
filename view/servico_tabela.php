...
if(isset($_SESSION['usuario'])){
	...
	<body>
		<div class="container">
			<h1 align="center" >Histórico de Serviços Realizados</h1>
			<div class="row">
				<div class="">
	...
	<script type="text/javascript">
		function adicionarDado(idservico){
			...
			$.ajax({
				...
				url:"../procedimentos/servico/obterDadosServico.php",
				success:function(r){
		...
		$(document).ready(function(){
			...
			$('#btnAdicionarServico').click(function(){
				...
				$.ajax({
					type:"POST",
					data:dados,
					url:"../procedimentos/servico/adicionarServico.php",
					success:function(r){
		...
		$(document).ready(function(){
			$('#btnAdicionarServicoU').click(function(){
				...
				$.ajax({
					type:"POST",
					data:dados,
					url:"../procedimentos/servico/atualizarServico.php",
					success:function(r){
